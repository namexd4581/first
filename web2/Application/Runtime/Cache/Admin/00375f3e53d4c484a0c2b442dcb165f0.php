...
<head>
  ...
  <link rel="icon" type="image/png" href="/Web/Public/Admin/i/favicon.png">
  <link rel="apple-touch-icon-precomposed" href="/Web/Public/Admin/i/app-icon72x72@2x.png">
  <meta name="apple-mobile-web-app-title" content="Amaze UI" />
  <link rel="stylesheet" href="/Web/Public/Admin/css/amazeui.min.css"/>
  ...
  <div class="admin-sidebar am-offcanvas" id="admin-offcanvas">
    <div class="am-offcanvas-bar admin-offcanvas-bar">
      <ul class="am-list admin-sidebar-list am-pagination" >
        ...
        <li><a href="admin-table.html"><span class="am-icon-table"></span> 活动展示</a></li>
        <li><a href="admin-form.html"><span class="am-icon-pencil-square-o"></span> 荣誉展示</a></li>
      </ul>
...
<div class="am-tab-panel am-fade am-active am-in" id="">
	<form class="am-form" method="post" action="/Web/index.php/Admin/Index/insert">
...
<script src="/Web/Public/Admin/js/amazeui.ie8polyfill.min.js"></script>
<![endif]-->

<!--[if (gte IE 9)|!(IE)]><!-->
<script src="/Web/Public/Admin/js/jquery.min.js"></script>
<!--<![endif]-->
<script src="/Web/Public/Admin/js/amazeui.min.js"></script>
<script src="/Web/Public/Admin/js/app.js"></script>
</body>
</html>